package top.dc.requestservice.crawier;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://www.csdn.net/";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"floor-www-index_558\"]/div/div[3]/div[1]/div[2]/div[1]/div[2]/div/div/a");
